...
_END;
        ...
        <div id="profileTabs">
            <ul>
                <a href="overview.php"><li id="overview3">OVERVIEW</li></a>
                <a href="posts.php"><li id="posts3">POSTS</li></a>
                <a href="upvotes.php"><li id="upvotes3">UPVOTES</li></a>
                <a href="comments.php"><li id="comments3">COMMENTS</li></a>
            </ul>
            <hr/>
        </div>
        <div id="postsUpvotedCommented">
            <p>Posts you upvoted will show up here</p>
