...
_END;
        ...
        <div id="profileTabs">
            <ul>
                <a href="overview.php"><li id="overview4">OVERVIEW</li></a>
                <a href="posts.php"><li id="posts4">POSTS</li></a>
                <a href="upvotes.php"><li id="upvotes4">UPVOTES</li></a>
                <a href="comments.php"><li id="comments4">COMMENTS</li></a>
            </ul>
            <hr/>
        </div>
        <div id="postsUpvotedCommented">
            <p>Posts you commented will show up here</p>
