...
_END;
        ...
        <div id="profileTabs">
            <ul>
                <a href="overview.php"><li id="overview1">OVERVIEW</li></a>
                <a href="posts.php"><li id="posts1">POSTS</li></a>
                <a href="upvotes.php"><li id="upvotes1">UPVOTES</li></a>
                <a href="comments.php"><li id="comments1">COMMENTS</li></a>
            </ul>
            <hr/>
        </div>
        <div id="postsUpvotedCommented">
            <p>Posts you upvoted and commented will show up here</p>
            <a href='javascript:void(0);' id='whatsHot'>Checkout What's Hot</a>
        </div>
        <br/><br/><br/>
        </div>
        <div id='popUps'>
